...
public class HostNetworkTetris extends JPanel implements ActionListener, KeyListener
{
	...
	{
		new HostNetworkTetris();
	}
	public HostNetworkTetris()
	{	  
        ...
        fb=new FakeBlock[20][10];
		  ...
		  time=new javax.swing.Timer(1000, new TetrisHostListener());
		  supermodetime=new javax.swing.Timer(30000, new SuperModeHostListener());
		...
		/* try
{
	...
	music.start();
          ...
          new Thread(new outHostThread(clientSocket,gr)).start();
          new Thread (new inHostThread(clientSocket)).start();
 ...
 class outHostThread extends Thread 
{
	...
	public outHostThread(Socket c, Grid gr)
	{
		clientSocket=c;
	...
	public void run()
    {
    	...
    	{
    		System.out.println("Unable to establish ObjectOutputStream");
    	}
        ...
        while(!HostNetworkTetris.lose)
        {
        try
        	{
       			out.writeObject(outconv.getString());
       			outconv.change(HostNetworkTetris.gr);
       		//	System.out.println(outconv.getString());
        	}
        catch(IOException e)
        {
...
class inHostThread extends Thread
{	
		/**The socket connected with the client
	 **/
	Socket clientSocket=null;
	 ...
	 **/
	static String rep="";
	public inHostThread(Socket c)
	{
		clientSocket=c;

		//inc=new InConverter(jframe);
